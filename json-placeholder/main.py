...
class TestPost():
    ...
    @pytest.mark.parametrize("method,title,body,userId",
                             [('PUT', 'foo', 'bar', '1'), ('PATCH', 'foo', 'bar', '1'), ('PATCH', None, 'bar', '2'),
                              ('PATCH', 'foo', None, '1'), ('PATCH', 'foo', 'bar', None), ('PATCH', None, None, None)])
